    ...
    *,
    ...
    return {
        ...
        "evidenceConclusions": [
            ...
            (
                "Do not alter Hora. The two-row case-8 disagreement is one "
                "categorical award only; the award flips across a sunrise input "
                "separated by only a few minutes, so a visible JHora sunrise "
                "witness is required."
            ),
            (
        ...
        "nextWitness": {
            "hora": (
                "Capture case-8 JHora apparent-tip sunrise in LMT under the "
                "locked settings."
            ),
            "ayana": (
                "Capture visible JHora tropical longitudes or intermediate "
                "Kranti for the seven 1889 planets."
            ),
        },
    }
