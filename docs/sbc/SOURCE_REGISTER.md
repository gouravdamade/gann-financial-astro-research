...
| Trailokya Dipika 1972 original scan, SHA-256 `1EF82899...` | Sanskrit compilation, Hindi commentary, and practical introduction | Complete 118-page private scan; TD1R source-closes a native 81-cell board, enumerated 28-row Vedha targets, source expansions, categorical nature passages, and coarse motion classifier. Exact-speed, stationary, modifier-precedence, Moon-boundary and financial use remain fail-closed. |
