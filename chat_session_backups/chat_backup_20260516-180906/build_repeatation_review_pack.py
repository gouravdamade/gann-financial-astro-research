...
<body>
  ...
  <main>
    ...
    <p class="note">
      ...
      <b>Reset Cursor</b> if browser annotation mode leaves the page cursor visually stuck after
      disabling annotations. The chart overlays crosshair markers/ignore regions and generates Python
