...
def build_summary(
    *,
    ...
    return {
        ...
        "evidenceConclusions": [
            (
                "Retain the LMT Nathonnatha source profile. It is the best of "
                "the tested time bases against visible JHora and independently "
                "reproduces the two published rounded worked tables closely."
            ),
            (
                "Do not alter Hora merely from this diagnostic. The former "
                "case-8 disagreement is one categorical award separated by only "
                "a few minutes of sunrise input; the separate fail-closed "
                "intermediate gate owns visible sunrise and award provenance."
            ),
            (
        ...
        "nextWitness": {
            "hora": (
                "Evaluate the case-8 apparent-tip sunrise and award through the "
                "separate hashed intermediate witness gate."
            ),
            "ayana": (
                "Evaluate seven visible historical tropical positions and Ayana "
                "values through the separate hashed intermediate witness gate."
            ),
        },
    }
...
def render_report(summary: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "This is a boundary-input dispute, not evidence for replacing the Hora "
        "sequence. The missing witness is JHora's visible sunrise under the "
        "locked apparent-tip setting.",
        "",
