...
def build_summary(
    ...
    summary = {
        ...
        "decisions": [
            ...
            (
                "Recognize Hora as independently witness-aligned in 35/35 rows. "
                "The exact case-8 packet binds the visible LMT sunrise, Moon "
                "Hora lord, and all seven awards. This is component evidence "
                "only, not aggregate Kaala or full Shadbala certification."
            ),
            (
...
def render_report(summary: dict[str, Any]) -> str:
    ...
    lines.extend(
        [
            "",
            "Paksha and Hora now have direct visible support in 35/35 rows. "
            "The exact case-8 Hora packet binds JHora's visible LMT sunrise, "
            "Moon lord, and seven awards. Nathonnatha, Ayana, and aggregate "
            "Kaala remain provisional.",
            "",
            "## Chesta Decision",
            "",
            (
