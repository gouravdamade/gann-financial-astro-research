...
- Report version: `astro_certification_4_gate_v12_kaala_capture_assistant_20260729`
- Generated: `2026-07-29T15:50:06+05:30`
...
Intermediate witness status: `blocked_pending_visible_kaala_intermediate_witness` (7 Hora rows; 7 Ayana rows). The pending templates require visible, hashed JHora inputs and keep production changes disabled.

Guided capture assistant: `available`. It records reviewer-visible values, hashes the selected evidence, validates all seven planets, and cannot read JHora automatically, infer astrology values, overwrite the pending templates, or unlock execution.
