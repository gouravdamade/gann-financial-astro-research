...
DEFAULT_DOCTRINE_CONFIG: dict[str, Any] = {
    "config_id": "doctrine_v7_20260729_visible_sthana_reconciliation",
    ...
    "shadbala": {
        ...
        "doctrine_decisions": {
            ...
            "saptavargaja_policy": "BPHS_source_weights_with_named_PyJHora_and_visible_JHora_comparator_profiles_and_degree_bounded_D1_moolatrikona",
