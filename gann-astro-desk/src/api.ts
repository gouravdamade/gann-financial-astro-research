...
export async function fetchCgvoWorkbench(input: { eventType: 'SOLAR' | 'LUNAR'; globalMaxSwissUt?: string; globalMaxUtc?: string; causalEventId?: string; localityId?: string; label?: string; latitude?: number; longitude?: number; elevationM?: number; timezone?: string; startUtc?: string; endUtc?: string; absoluteFrameProfileId?: string }): Promise<CgvoWorkbench> {
