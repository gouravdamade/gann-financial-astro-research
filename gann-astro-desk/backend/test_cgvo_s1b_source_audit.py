...
class CgvoS1bSourceAuditTests(unittest.TestCase):
    ...
    def test_explicit_chitra_candidates_do_not_replace_the_existing_selected_frame(self) -> None:
        ...
        self.assertEqual(candidate_ids[:3], [
            "CHITRA_180_TRUE_STAR",
            "CHITRA_180_APPARENT_STAR",
            "CHITRA_180_MEAN_ECLIPTIC",
        ])
        with self.assertRaisesRegex(CgvoRequestError, "absoluteFrameProfileId"):
            build_cgvo_workbench(PROJECT_ROOT, {
                ...
                "absoluteFrameProfileId": "CHITRA_180_TRUE_STAR",
    ...
    def test_modern_audit_is_epoch_explicit_and_refuses_magha_averaging(self) -> None:
        ...
        for epoch in output["epochs"]:
            ...
            apparent = profiles["CHITRA_180_APPARENT_STAR"]
            ...
            self.assertEqual(magha["calculationStatus"], "NOT_CALCULATED")
            self.assertIsNone(magha["maghaAnchorOffsetDeg"])
            self.assertIsNone(magha["chitraMaghaDifferenceArcMinutes"])
        ...
        selected = next(item for item in apparent_2025 if item["profileId"] == "CHITRA_180_APPARENT_STAR")
    ...
    def test_firmament_remains_raw_geometry_without_downstream_classifier(self) -> None:
        ...
        self.assertEqual(status["milestone"], "CGVO-S1B")
