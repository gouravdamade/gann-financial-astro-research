...
DEFAULT_DOCTRINE_CONFIG: dict[str, Any] = {
    "config_id": "doctrine_v4_20260718_named_formula_diagnostics",
    ...
    "shadbala": {
        "method": "strict_shadbala_v7_named_formula_diagnostics_provisional",
        "status": "provisional_bphs_source_profile_with_named_shared_input_diagnostics_pending_jhora_witness",
        ...
        "doctrine_decisions": {
            ...
            "comparator_policy": "end_to_end_source_profile_plus_kaala_subcomponents_plus_shared_input_formula_matrices",
